...
<section class="signup-section pt-100 pb-80" style="background-color: #EBFBF8;">
                            ...
                            <div class="card shadow-sm">
                                ...
                                <div class="card-body">
                                    <div class="text-center mb-3">
                                        <img src="assets/img/img_profile.png" class="rounded-circle" alt="Profile Picture">
                                    </div>
    ...
    <?php 
    echo !empty($user['created_at']) ? date("F j, Y", strtotime($user['created_at'])) : "Date not available"; 
    ?>
</li>
                                    </ul>
